...
To ensure we could spend most of the time for the project on training, we decided to use [ibab's](https://github.com/ibab/tensorflow-wavenet) implementation of the methodology.
